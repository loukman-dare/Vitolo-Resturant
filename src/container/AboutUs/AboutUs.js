    ...
    <div className="app__aboutus app__bg flex__center section__pading" id="about">
      ...
      <div className="app__aboutus-content flex__center">
        <div className="app__aboutus-content_about">
          ...
          <p className={`p__opensans ${!showAbout && 'line-clamp'}`}>vitolo is more than just a great meal! Along with great scenary and world class service, our incredible menu has been cleverly and creatively crafted with amazing food flavor combinations and wines to choose from. We create culinary poetry.</p>
